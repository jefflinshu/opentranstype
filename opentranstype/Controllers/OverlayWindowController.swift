...
final class OverlayWindowController {
    ...
    private let onManageLanguages: () -> Void
    private var window: NSPanel?
    private var userMovedWindow = false
    private var dragStartOrigin: CGPoint?
    private var resizeStartFrame: NSRect?

    init(model: TranslatorModel, accessibility: AccessibilityTextController, onRefresh: @escaping () -> Void, onUpgrade: @escaping () -> Void, onClose: @escaping () -> Void, onManageLanguages: @escaping () -> Void) {
        self.model = model
